...
/*   Updated: 2022/10/27 16:58:25 by humartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/minishell.h"

// void	ft_close_pipes_bis(int tube[2][2])
// {
// 	close(tube[0][0]);
// 	close(tube[0][1]);
// 	close(tube[1][0]);
...
// void	ft_pipe_tmp(t_tube child1, t_tube child2, t_tube child3, int tube[2][2])
// {
// 	ft_close_pipes_bis(tube);
// 	waitpid(child1.pid, NULL, 0);
// 	waitpid(child3.pid, NULL, 0);
...
// 		ft_pipe_tmp(child1, child2, child3, tube);
// }
